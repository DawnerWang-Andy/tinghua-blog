...
**门**：不存在（A线）→ 永远开着（B-2）→ 关上又开（B-9）→ 半开（B-21）→ 一条门缝（C-8）
**椅子**：两把无第三把（B-2）→ 坐的人变了（B-12）→ 陈远平坐到对面（B-19）→ 转了15度（B-23）
...
> 完整导演阐述（含每场戏功能标注）见 `/scripts/director-notes/`。
...
**主编**
销量曲线在第三个月开始平了。我们需要第二本书。

**林小野**
（看着报表——没什么表情）
&nbsp;&nbsp;&nbsp;&nbsp;没有第二本。这套东西——我只能写一次。

主编身体往后靠。和旁边的市场总监交换了一个眼神。

**主编**
那就做讲座。做巡讲。做线上课程。同样的方法论——换个包装。

小野看着窗外。玻璃幕墙外是这个城市的雾霾天。他转回头。没有说好。没有说不好。主编当他默认了。
...
退书男站了一会儿。然后转身往门口走。书夹在腋下。又有两个人站起来跟他一起。脚步声在安静的过道里很响。门开——门关。剩下的人继续坐着，手里的书不知道该放哪里。
...
**眼镜男（O.S.）**
那您现在呢？您站在台上分析他是怎么控制您的——同时您也在卖书给我们、教我们用同样的方法——您和他有什么区别？
...
**场控**
（压低到只有小野能听到——但靠近讲台话筒，有一两个字漏了出来）
&nbsp;&nbsp;&nbsp;&nbsp;林老师，主办方说——时间差不多了。签售台已经准备好了。
...
**主持人**
（对着话筒——声音很亮，语速快，想把气氛往回拉）
&nbsp;&nbsp;&nbsp;&nbsp;感谢林老师精彩的分享！签售台就在门口——感兴趣的朋友可以去领取签名。下周同一时间我们还有新的主题讲座，名额有限——
